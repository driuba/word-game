...
export class WordRights1755001316062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "WordRights" ("ChannelId" character varying(50) NOT NULL, "Created" timestamp with time zone NOT NULL DEFAULT now(), "Id" SERIAL NOT NULL PRIMARY KEY)`);
