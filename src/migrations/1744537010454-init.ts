...
export class Init1744537010454 implements MigrationInterface {
    name = 'Init1744537010454'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Words" ("ChannelId" varchar(50) NOT NULL, "Created" datetime NOT NULL DEFAULT (datetime('now')), "Id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "Score" integer NOT NULL DEFAULT (0), "Modified" datetime NOT NULL DEFAULT (datetime('now')), "UserIdCreator" varchar(50) NOT NULL, "UserIdGuesser" varchar(50) NOT NULL, "Word" varchar NOT NULL)`);
